...
class TestGetColumnValues:
    ...
    def test_get_column_values_api_error_retries(self):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.col_values.side_effect = [Exception("API Error"), ["Header", "Value1"]]
...
class TestPopFirstRow:
    ...
    def test_pop_first_row_column_not_found(self):
        ...
        result = pop_first_row_by_columns(
            mock_worksheet, mapping, {}, "nonexistent_column", "worker1"
        )
    ...
    def test_pop_first_row_no_rows_available(self):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.get_all_values.return_value = [["id", "name", "claim"]]

        mapping = {"id": 0, "name": 1, "claim": 2}

        result = pop_first_row_by_columns(mock_worksheet, mapping, {}, "claim", "worker1")
    ...
    def test_pop_first_row_filter_mismatch_continues(self, mock_verify):
        ...
        result = pop_first_row_by_columns(
            mock_worksheet, mapping, {"status": "PENDING"}, "claim", "worker1"
        )
    ...
    def test_pop_first_row_claim_update_error(self, mock_verify):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.get_all_values.return_value = [["id", "name", "claim"], ["1", "Alice", ""]]
...
class TestSelectOperations:
    ...
    def test_select_first_by_columns_success(self):
        ...
        result = select_first_by_columns(mock_worksheet, mapping, {"status": "PENDING"})
    ...
    def test_select_first_empty_row_skipped(self):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.get_all_values.return_value = [["id", "status"], [], ["1", "PENDING"]]
    ...
    def test_select_all_by_columns_success(self):
        ...
        result = select_all_by_columns(mock_worksheet, mapping, {"status": "PENDING"})
    ...
    def test_select_all_by_columns_empty(self):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.get_all_values.return_value = [["id", "status"], ["1", "DONE"]]
...
class TestAppendOperations:
    ...
    def test_append_rows_success(self):
        ...
        rows = [["1", "Alice", "PENDING"], ["2", "Bob", "DONE"]]
...
class TestGetOperations:
    ...
    def test_get_rows_success(self):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.get.return_value = [["1", "Alice"], ["2", "Bob"]]
    ...
    def test_get_next_valid_row_success(self):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.get_all_values.return_value = [["id", "name"], ["", ""], ["1", "Alice"]]
    ...
    def test_get_next_valid_row_none_found(self):
        ...
        mock_worksheet = Mock()
        mock_worksheet.title = "TestSheet"
        mock_worksheet.get_all_values.return_value = [["id", "name"], ["", ""], ["  ", "  "]]
...
class TestUpdateAndDeleteOperations:
    ...
    def test_delete_row_ownership_failed(self, mock_verify):
        ...
        result = delete_row(mock_worksheet, 2, claim_column_index=2, claim_value="worker1")
