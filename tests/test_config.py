...
class TestConfig:
    ...
    def test_config_missing_worker_name_raises_error(self):
        ...
        with patch.dict(
            os.environ,
            {"SPREADSHEET_ID": "test_sheet_id", "SERVICE_ACCOUNT_FILE": "test_account.json"},
            clear=True,
        ):
    ...
    def test_config_missing_spreadsheet_id_raises_error(self):
        ...
        with patch.dict(
            os.environ,
            {"WORKER_NAME": "test_worker", "SERVICE_ACCOUNT_FILE": "test_account.json"},
            clear=True,
        ):
    ...
    def test_config_missing_service_account_file_raises_error(self):
        ...
        with patch.dict(
            os.environ,
            {"WORKER_NAME": "test_worker", "SPREADSHEET_ID": "test_sheet_id"},
            clear=True,
        ):
