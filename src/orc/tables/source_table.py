...
class SourceTable:
    ...
    def __init__(self, spreadsheet: Spreadsheet, worker_name: str):
        ...
        self.sources_ws: Worksheet = get_worksheet(
            spreadsheet, SOURCES_TABLE_NAME, SOURCES_TABLE_HEADER, replace_header=False, create=True
        )
    ...
    def claim_next_source(self) -> tuple[int, SourceEntry] | None:
        """
        ...
        while True:
            ...
            logger.info(
                f"Fonte reivindicada e metadados extraídos: {source.source_id} (linha {row_number})"
            )
